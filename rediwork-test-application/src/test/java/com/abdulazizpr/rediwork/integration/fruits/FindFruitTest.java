...
public class FindFruitTest {
    ...
    @Test
    public void test_find_fruit_success_200() throws IOException {
        String expectedResponse = TestHelper
                .readJsonContent("api/spec/fruits/find-fruit/find-fruits-success-200.json");
    ...
    @Test
    public void test_find_fruit_error_400() throws IOException {
        String expectedResponse = TestHelper
                .readJsonContent("api/spec/fruits/find-fruit/find-fruits-error-400.json");
